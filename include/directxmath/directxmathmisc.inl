...
inline XMVECTOR XM_CALLCONV XMColorHSLToRGB(FXMVECTOR hsl) noexcept
{
    ...
    else
    {
        ...
        XMVECTOR r = MathInternal::XMColorHue2Clr(p, q, XMVectorAdd(h, oneThird));
        XMVECTOR g = MathInternal::XMColorHue2Clr(p, q, h);
        XMVECTOR b = MathInternal::XMColorHue2Clr(p, q, XMVectorSubtract(h, oneThird));
